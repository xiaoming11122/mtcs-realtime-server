...
nohup java -jar ../mtcs-realtime-server-*.jar  --REGISTRY_SERVICE_URL='http://admin:Ffcs&2019@10.30.17.7:18080/eureka/,http://admin:Ffcs&2019@10.30.17.8:18080/eureka/' --IP_ADDRESS="${ip_addr}"  --LOG_DIR_PATH='../../logs' >nohup.out 2>&1 &
sleep 2
