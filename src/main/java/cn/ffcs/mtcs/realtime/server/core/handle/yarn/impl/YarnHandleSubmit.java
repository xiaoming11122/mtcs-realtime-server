...
@Component
@Slf4j
public class YarnHandleSubmit implements IYarnHandle, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        YarnHandleFactory.registerYarnState(YarnStateEnum.SUBMITTED.getValue(), this);
    }
    ...
    public boolean startHandle(RtMonitor rtMonitor, String engineName) {
        ...
        if (monitorCount >= rtMonitor.getMonitorNum()) {
            ...
            // 2 更新监控表
            rtMonitor.setMonitorActual(YarnStateEnum.SUBMITTED.getValue());
