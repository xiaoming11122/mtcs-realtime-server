...
@Component
@Slf4j
public class YarnHandleAccept implements IYarnHandle, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        YarnHandleFactory.registerYarnState(YarnStateEnum.ACCEPTED.getValue(), this);
    }
    ...
    public boolean startHandle(RtMonitor rtMonitor, String engineName) {
        ...
        if (monitorCount >= rtMonitor.getMonitorNum()) {
            ...
            // 2 更新监控表
            rtMonitor.setMonitorActual(YarnStateEnum.ACCEPTED.getValue());
