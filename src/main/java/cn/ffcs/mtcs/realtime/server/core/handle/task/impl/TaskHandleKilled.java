...
@Component
@Slf4j
public class TaskHandleKilled implements ITaskHandle, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        TaskHandleFactory.registerTaskState(TaskStateEnum.KILLED.getValue(), this);
    }
    ...
    public boolean startHandle(RtMonitor rtMonitor, String engineName) {
        ...
        // 2 更新监控表
        rtMonitor.setMonitorActual(TaskStateEnum.KILLED.getValue());
