...
@Component
@Slf4j
public class YarnHandleNewSaving implements IYarnHandle, InitializingBean {
    @Autowired
    ...
    public void afterPropertiesSet() throws Exception {
        YarnHandleFactory.registerYarnState(YarnStateEnum.NEW_SAVING.getValue(), this);
    }
    ...
    public boolean startHandle(RtMonitor rtMonitor, String engineName) {
        ...
        if (monitorCount >= rtMonitor.getMonitorNum()) {
            ...
            // 2 更新监控表
            rtMonitor.setMonitorActual(YarnStateEnum.NEW_SAVING.getValue());
