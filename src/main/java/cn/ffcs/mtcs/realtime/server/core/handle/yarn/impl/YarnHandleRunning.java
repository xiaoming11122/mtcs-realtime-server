...
@Component
@Slf4j
public class YarnHandleRunning implements IYarnHandle, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        YarnHandleFactory.registerYarnState(YarnStateEnum.RUNNING.getValue(), this);
    }
    ...
    public boolean startHandle(RtMonitor rtMonitor, String engineName) {
        ...
        // 2 更新监控表中获取到的状态
        rtMonitor.setMonitorActual(YarnStateEnum.RUNNING.getValue());
    ...
    public boolean runHandle(RtMonitor rtMonitor, String engineName) {
        ...
        rtMonitor.setMonitorActual(YarnStateEnum.RUNNING.getValue());
        monitorService.updateById(rtMonitor);
        //任务是运行状态，yarn是运行状态需要更新  RtTaskLastState
