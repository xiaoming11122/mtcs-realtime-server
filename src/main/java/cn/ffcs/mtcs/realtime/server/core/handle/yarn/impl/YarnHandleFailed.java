...
@Component
@Slf4j
public class YarnHandleFailed implements IYarnHandle, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        YarnHandleFactory.registerYarnState(YarnStateEnum.FAILED.getValue(), this);
    }
    ...
    public boolean startHandle(RtMonitor rtMonitor, String engineName) {
        ...
        // 2 更新监控表
        rtMonitor.setMonitorActual(YarnStateEnum.FAILED.getValue());
