...
@Component
@Slf4j
public class TaskHandleFailed implements ITaskHandle, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        TaskHandleFactory.registerTaskState(TaskStateEnum.FAILED.getValue(), this);
    }
    ...
    public boolean startHandle(RtMonitor rtMonitor, String engineName) {
        ...
        // 2 更新监控表
        rtMonitor.setMonitorActual(TaskStateEnum.FAILED.getValue());
