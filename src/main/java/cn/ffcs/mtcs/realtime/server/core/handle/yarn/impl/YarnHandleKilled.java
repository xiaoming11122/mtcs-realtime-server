...
@Component
@Slf4j
public class YarnHandleKilled implements IYarnHandle, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        YarnHandleFactory.registerYarnState(YarnStateEnum.KILLED.getValue(), this);
    }
    ...
    public boolean startHandle(RtMonitor rtMonitor, String engineName) {
        ...
        // 2 更新监控表
        rtMonitor.setMonitorActual(YarnStateEnum.KILLED.getValue());
